<img width="1899" height="808" alt="image" src="https://github.com/user-attachments/assets/38e21a07-d505-45e7-9fef-9aef0f4fe8fb" />🚀 TaskBuddy is a powerful task management app built using ReactJS. It helps users manage daily tasks with ease — add, update, delete, track progress, and clear all tasks with just one click!
